...
// @ts-ignore
import H12IndungHero from '@/app/[slug]/_blocks/indung/H12IndungHero'
// @ts-ignore
...
const REAL_BLOCKS: Record<string, boolean> = {
  ...
  'H-06':true,'H-07':true,'H-08':true,'H-09':true,'H-10':true,'H-11':true,'H-12':true,'H-13':true,
  'D-01':true,
...
export default async function BlockPreviewPage(
  ...
  if (code === 'H-13') return <div style={{ margin:0, padding:0, overflow:'hidden' }}><FiveHundredLanternHeroBlock config={{ templeName:'천관사', templeNameHanja:'天冠寺', currentRound:1, targetCount:500, currentCount:127, ctaLink:'#', tagline:'부처님오신날 인등 공양 동참 불사' }} /></div>
