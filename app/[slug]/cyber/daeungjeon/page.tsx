    ...
    <div className="dj-root">
      ...
      <div className="dj-altar-area">
        <svg viewBox="0 0 500 160" className="dj-altar-svg">
          ...
          {incenseBurning && <>{[{ cx: 248, cy: 4, d: 4 }, { cx: 251, cy: 0, d: 3.5 }, { cx: 250, cy: -5, d: 4.5 }, { cx: 246, cy: -2, d: 5 }, { cx: 253, cy: 2, d: 3.8 }, { cx: 249, cy: -8, d: 4.2 }].map((s, i) => <circle key={i} cx={s.cx} cy={s.cy} r="4" fill="rgba(192,192,210,0.45)"><animate attributeName="cy" values={`${s.cy};${s.cy - 60};${s.cy - 120}`} dur={`${s.d}s`} repeatCount="indefinite"/><animate attributeName="r" values="4;8;12" dur={`${s.d}s`} repeatCount="indefinite"/><animate attributeName="opacity" values="0.5;0.2;0" dur={`${s.d}s`} repeatCount="indefinite"/></circle>)}
