      ...
      <div className="dj-altar-area">
        <svg viewBox="0 0 500 160" className="dj-altar-svg">
          ...
          <g opacity={candlesLit >= 1 ? 1 : 0.25}>
            {candlesLit >= 1 && <circle cx="170" cy="38" r="36" fill="rgba(255,200,50,0.12)"><animate attributeName="r" values="32;40;32" dur="2s" repeatCount="indefinite"/></circle>}
            <rect x="165" y="68" width="10" height="4" rx="2" fill="#B8860B"/><rect x="166" y="38" width="8" height="32" rx="3" fill="#F5E6B8"/><rect x="169" y="32" width="2" height="8" fill="#666"/>
          ...
          <g opacity={candlesLit >= 2 ? 1 : 0.25}>
            {candlesLit >= 2 && <circle cx="330" cy="38" r="36" fill="rgba(255,200,50,0.12)"><animate attributeName="r" values="32;40;32" dur="2.3s" repeatCount="indefinite"/></circle>}
            <rect x="325" y="68" width="10" height="4" rx="2" fill="#B8860B"/><rect x="326" y="38" width="8" height="32" rx="3" fill="#F5E6B8"/><rect x="329" y="32" width="2" height="8" fill="#666"/>
          ...
          {incenseBurning && <>{[{ cx: 248, cy: 4, d: 4 }, { cx: 251, cy: 0, d: 3.5 }, { cx: 250, cy: -5, d: 4.5 }, { cx: 246, cy: -2, d: 5 }, { cx: 253, cy: 2, d: 3.8 }, { cx: 249, cy: -8, d: 4.2 }].map((s, i) => <circle key={i} cx={s.cx} cy={s.cy} r="4" fill="rgba(200,200,200,0.3)"><animate attributeName="cy" values={`${s.cy};${s.cy - 60};${s.cy - 120}`} dur={`${s.d}s`} repeatCount="indefinite"/><animate attributeName="r" values="4;8;12" dur={`${s.d}s`} repeatCount="indefinite"/><animate attributeName="opacity" values="0.4;0.15;0" dur={`${s.d}s`} repeatCount="indefinite"/></circle>)}
