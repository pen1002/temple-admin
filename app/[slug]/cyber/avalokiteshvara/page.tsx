        ...
        <div style={{ width: 160, height: 212, margin: '0 auto 8px', borderRadius: 6, background: '#0d0608', position: 'relative', overflow: 'hidden', border: '1px solid rgba(201,168,76,0.2)' }}>
          ...
          <div style={{ display:'flex',width:'100%',height:'88%',marginTop:'12%',position:'relative' }}>
            ...
            <div style={{ flex:1,position:'relative' }}>
              ...
              <img src="https://res.cloudinary.com/db3izttcy/image/upload/w_300,q_auto,f_auto/bodisatt_quikgz" alt="관세음보살" style={{ position:'absolute',top:'2%',left:0,right:0,width:'100%',height:'79%',objectFit:'contain',mixBlendMode:'lighten',filter:'drop-shadow(0 0 10px rgba(255,200,80,0.65)) brightness(1.1)',zIndex:4 }} />
            ...
            >
              ...
              <div style={{ display:'flex',width:'100%',height:'88%',marginTop:'12%',position:'relative' }}>
                ...
                <div style={{ flex:1,position:'relative' }}>
                  ...
                  <img src="https://res.cloudinary.com/db3izttcy/image/upload/w_300,q_auto,f_auto/bodisatt_quikgz" alt="" style={{ position:'absolute',top:'2%',left:0,right:0,width:'100%',height:'79%',objectFit:'contain',mixBlendMode:'lighten',filter:lit?'drop-shadow(0 0 5px rgba(255,200,80,0.65)) brightness(1.1)':'none',opacity:lit?1:0.1,zIndex:4 }} />
