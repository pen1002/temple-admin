...
export default function OfferingBlock({ temple, config }: Props) {
  const sectionTitle = typeof config.sectionTitle === 'string' ? config.sectionTitle : '기도 불사동참'
  ...
  const defaultPlans: PlanItem[] = [
    { icon: '🕯️', name: '기본 인등',           price: '₩50,000/월',  desc: '' },
    { icon: '🌱', name: '땅 한 평 사기',         price: '1평 20만원',  desc: '' },
    { icon: '📿', name: '일년기도',             price: '₩300,000/년', desc: '' },
    { icon: '🙏', name: '49재·천도재 불사동참', price: '종무소 문의', desc: '' },
  ]
