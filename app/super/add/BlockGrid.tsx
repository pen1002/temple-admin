...
export const BLOCK_CATALOG: Record<CatKey, BlockItem[]> = {
  ...
  H: [
    ...
    { code: 'H-14', name: '초파일연등형',         desc: '부처님오신날 연등 공양 · 250등 단위 5차 · 행→열 순차 화폭형', tags: ['연등', '초파일', '화폭형', '부처님오신날'] },
    { code: 'H-15', name: '봉축장엄등행진',       desc: '7종 장엄등 퍼레이드 · 코끼리·손오공·화룡 · 불꽃놀이·연등줄', tags: ['장엄등', '퍼레이드', '봉축', '행렬'] },
  ],
  // ── 법회 (전면 재구성 BH-01~09) ─────────────────────────────────────────────
  BH: [
