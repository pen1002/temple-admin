...
export const BLOCK_CATALOG: Record<CatKey, BlockItem[]> = {
  H: [
    ...
    { code: 'H-05', name: '연등 부유형',          desc: '연등 흔들림 부유 애니메이션 (파티클 제외)',          tags: ['연등', '부유', '애니메이션'] },
    ...
    { code: 'H-08', name: '행사 전면 배치형',     desc: 'D-30 이내 행사 금색 강조',                         tags: ['행사', 'D-Day', '이벤트'] },
    { code: 'H-09', name: '계절 테마형',          desc: '봄·여름·가을·겨울 자동 전환',                      tags: ['계절', '테마', '자동'] },
    { code: 'H-10', name: '3D 모델형',            desc: 'Sketchfab 불상 3D 인터랙션',                        tags: ['3D', '불상', 'Sketchfab'] },
  ],
  T: [
